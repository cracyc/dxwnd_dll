...
typedef void (WINAPI *glTexImage1D_Type)(GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
typedef void (WINAPI *glTexImage2D_Type)(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
typedef void (WINAPI *glTexImage3D_Type)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
...
typedef void (WINAPI *glCopyTexImage1D_Type)(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLint);
...
extern void WINAPI extglTexImage1D(GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
extern void WINAPI extglTexImage2D(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
extern void WINAPI extglTexImage3D(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *);
extern void WINAPI extglPixelZoom(GLfloat, GLfloat);
extern void WINAPI extglBegin(GLenum);
extern void WINAPI extglEnd(void);
extern void WINAPI extglBindTexture(GLenum, GLuint);
extern void WINAPI extglPixelStorei(GLenum, GLint);
extern void WINAPI extglCopyTexImage1D(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLint);
...
DXWEXTERN glTexImage1D_Type pglTexImage1D;
DXWEXTERN glTexImage2D_Type pglTexImage2D;
DXWEXTERN glTexImage3D_Type pglTexImage3D;
DXWEXTERN glPixelZoom_Type pglPixelZoom DXWINITIALIZED; // must be initialized to NULL!
DXWEXTERN glBegin_Type pglBegin;
DXWEXTERN glEnd_Type pglEnd;
DXWEXTERN glBindTexture_Type pglBindTexture;
DXWEXTERN glPixelStorei_Type pglPixelStorei;
DXWEXTERN glCopyTexImage1D_Type pglCopyTexImage1D;
