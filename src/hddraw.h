...
typedef HRESULT (WINAPI *DDGetSurfaceFromDC_Type)(HDC, LPDIRECTDRAWSURFACE *);
...
typedef HRESULT (WINAPI *EnumSurfaces7_Type)(LPDIRECTDRAW, DWORD, LPDDSURFACEDESC2, LPVOID, LPDDENUMSURFACESCALLBACK7);
...
typedef HRESULT (WINAPI *GetSurfaceFromDC_Type)(LPDIRECTDRAW, HDC, LPDIRECTDRAWSURFACE4 *);
...
typedef HRESULT (WINAPI *GetDeviceIdentifierType)(LPDIRECTDRAW, LPDDDEVICEIDENTIFIER, DWORD);
...
extern HRESULT WINAPI PrimaryBlt(int, Blt_Type, LPDIRECTDRAWSURFACE, LPRECT, LPDIRECTDRAWSURFACE, LPRECT, DWORD, LPDDBLTFX);
extern HRESULT WINAPI PrimaryNoBlt(int, Blt_Type, LPDIRECTDRAWSURFACE, LPRECT, LPDIRECTDRAWSURFACE, LPRECT, DWORD, LPDDBLTFX);
extern HRESULT WINAPI PrimaryStretchBlt(int, Blt_Type, LPDIRECTDRAWSURFACE, LPRECT, LPDIRECTDRAWSURFACE, LPRECT, DWORD, LPDDBLTFX);
extern HRESULT WINAPI PrimaryFastBlt(int, Blt_Type, LPDIRECTDRAWSURFACE, LPRECT, LPDIRECTDRAWSURFACE, LPRECT, DWORD, LPDDBLTFX);
extern HRESULT WINAPI PrimaryBilinearBlt(int, Blt_Type, LPDIRECTDRAWSURFACE, LPRECT, LPDIRECTDRAWSURFACE, LPRECT, DWORD, LPDDBLTFX);

typedef void (WINAPI *EmuBlt_Type)(LPVOID, LPRECT, LONG, DWORD, LPVOID, LPRECT, LONG, DWORD);
typedef void (WINAPI *EmuGamma_Type)(LPVOID, LPRECT, LONG, DWORD);
typedef HRESULT (WINAPI *PrimaryBlt_Type)(int, Blt_Type, LPDIRECTDRAWSURFACE, LPRECT, LPDIRECTDRAWSURFACE, LPRECT, DWORD, LPDDBLTFX);

extern EmuBlt_Type pEmuBlt;
extern EmuGamma_Type pGammaCorrection;
