...
typedef DWORD	(WINAPI *timeGetSystemTime_Type)(LPMMTIME, UINT);
...
DXWEXTERN timeGetSystemTime_Type ptimeGetSystemTime DXWINITIALIZED;
...
extern DWORD WINAPI exttimeGetSystemTime(LPMMTIME, UINT);
