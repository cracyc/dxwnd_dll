...
typedef HFONT	(WINAPI *CreateFontA_Type)(int, int, int, int, int, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, LPCTSTR);
typedef HFONT	(WINAPI *CreateFontW_Type)(int, int, int, int, int, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, LPCWSTR);
typedef HFONT	(WINAPI *CreateFontIndirectA_Type)(const LOGFONTA *);
typedef HFONT	(WINAPI *CreateFontIndirectW_Type)(const LOGFONTW *);
...
DXWEXTERN CreateFontA_Type pGDICreateFontA DXWINITIALIZED;
DXWEXTERN CreateFontIndirectA_Type pGDICreateFontIndirectA DXWINITIALIZED;
DXWEXTERN CreateFontW_Type pGDICreateFontW DXWINITIALIZED;
DXWEXTERN CreateFontIndirectW_Type pGDICreateFontIndirectW DXWINITIALIZED;
...
DXWEXTERN SetViewportOrgEx_Type pOffsetViewportOrgEx DXWINITIALIZED;
...
DXWEXTERN GetWindowExtEx_Type pGetWindowExtEx DXWINITIALIZED;
...
DXWEXTERN SetWindowOrgEx_Type pOffsetWindowOrgEx DXWINITIALIZED;
...
extern HFONT WINAPI extCreateFontIndirectA(const LOGFONTA *);
extern HFONT WINAPI extCreateFontW(int, int, int, int, int, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, LPCWSTR);
extern HFONT WINAPI extCreateFontIndirectW(const LOGFONTW *);
...
extern BOOL WINAPI extOffsetViewportOrgEx(HDC, int, int, LPPOINT);
