...
dxwLibsHookTable_Type SysLibsTable[]={
	...
	NULL, NULL},
#ifdef HOOKUXTHEME
	{"uxtheme",		FALSE,	NULL,	DXWHOOK_HOOK, // SYSLIBIDX_UXTHEME
	HookUXTheme, Remap_UXTheme_ProcAddress},
#else
	...
	HookDirect3D10, Remap_d3d10_ProcAddress},
	{"d3d10_1",		FALSE,	NULL,	DXWHOOK_HOOK, // SYSLIBIDX_DIRECT3D10_1
	HookDirect3D10_1, Remap_d3d10_1_ProcAddress},
	...
	{"SMACKW32",	FALSE,	NULL,	DXWHOOK_EXTEND, // SYSLIBIDX_SMACKW32
	...
	{"SMKWAI32",	FALSE,	NULL,	DXWHOOK_EXTEND, // SYSLIBIDX_SMKWAI32
	...
	{"BINK2W32",		FALSE,	NULL,	DXWHOOK_NULL|DXWHOOK_EXTEND, // SYSLIBIDX_BINK2W32
	HookBink2W32, Remap_bink_ProcAddress},
	...
	NULL,	NULL},
	// {"DPLAYX",		FALSE,	NULL,	DXWHOOK_HOOK, // SYSLIBIDX_DPLAYX
	// HookDPlayX,	Remap_DPlayX_ProcAddress},
	...
	{"MSVCRT",		FALSE,	NULL,	DXWHOOK_HOOK|DXWHOOK_EXTEND, // SYSLIBIDX_MSVCRT
	...
	// {"MSVBVM60",	FALSE,	NULL,	DXWHOOK_HOOK, // SYSLIBIDX_MSVBVM60
	// HookVB6, NULL},
	{"FLASH.OCX",		FALSE,	NULL,	DXWHOOK_HOOK, // SYSLIBIDX_FLASH
	HookFlash, NULL},
	{"shell32",		FALSE,	NULL,	DXWHOOK_HOOK|DXWHOOK_EXTEND, // SYSLIBIDX_SHELL32
	HookShell32, Remap_Shell32_ProcAddress},
	{"Lz32",		FALSE,	NULL,	DXWHOOK_HOOK, // SYSLIBIDX_LZ32
	HookLz32, Remap_Lz32_ProcAddress},
	{"d3dxof",		FALSE,	NULL,	DXWHOOK_HOOK, // SYSLIBIDX_D3DXOF
	HookD3dxof, Remap_D3dxof_ProcAddress},
	//{"wail32",		FLzALSE,	NULL,	DXWHOOK_HOOK, // SYSLIBIDX_WAIL32
	//HookWAIL32, NULL},
