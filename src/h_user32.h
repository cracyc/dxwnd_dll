...
typedef LONG	(WINAPI *ChangeDisplaySettingsExW_Type)(LPCWSTR, DEVMODEW *, HWND, DWORD, LPVOID);
...
typedef HWND	(WINAPI *CreateDialogIndirectParamW_Type)(HINSTANCE, LPCDLGTEMPLATEW, HWND, DLGPROC, LPARAM);
typedef HWND	(WINAPI *CreateDialogParam_Type)(HINSTANCE, LPVOID, HWND, DLGPROC, LPARAM);
...
typedef int		(WINAPI *DrawTextExA_Type)(HDC, LPCSTR, int, LPRECT, UINT, LPDRAWTEXTPARAMS);
...
typedef LONG	(WINAPI *EnumDisplaySettingsA_Type)(LPCSTR, DWORD, LPDEVMODEA);
typedef LONG	(WINAPI *EnumDisplaySettingsW_Type)(LPCWSTR, DWORD, LPDEVMODEW);
...
typedef ATOM	(WINAPI *RegisterClassW_Type)(const WNDCLASSW *);
...
typedef INT_PTR (WINAPI *DialogBoxParamA_Type)(HINSTANCE, LPCSTR, HWND, DLGPROC, LPARAM);
typedef INT_PTR (WINAPI *DialogBoxParamW_Type)(HINSTANCE, LPCWSTR, HWND, DLGPROC, LPARAM);
...
typedef INT_PTR (WINAPI *DialogBoxIndirectParamW_Type)(HINSTANCE, LPCDLGTEMPLATE, HWND, DLGPROC, LPARAM);
typedef HWND	(WINAPI *GetTopWindow_Type)(HWND);
...
typedef HBITMAP (WINAPI *LoadBitmapW_Type)(HINSTANCE, LPCWSTR);
...
typedef HANDLE	(WINAPI *LoadImageW_Type)(HINSTANCE, LPCWSTR, UINT, int, int, UINT);
...
DXWEXTERN CreateDialogIndirectParamW_Type pCreateDialogIndirectParamW DXWINITIALIZED;
DXWEXTERN CreateDialogParam_Type pCreateDialogParamA DXWINITIALIZED;
DXWEXTERN CreateDialogParam_Type pCreateDialogParamW DXWINITIALIZED;
...
DXWEXTERN EnumDisplaySettingsA_Type pEnumDisplaySettingsA DXWINITIALIZED;
DXWEXTERN EnumDisplaySettingsW_Type pEnumDisplaySettingsW DXWINITIALIZED;
...
DXWEXTERN CreateDesktop_Type pCreateDesktopA DXWINITIALIZED;
...
DXWEXTERN DialogBoxParamW_Type pDialogBoxParamW DXWINITIALIZED;
...
DXWEXTERN DialogBoxIndirectParamW_Type pDialogBoxIndirectParamW DXWINITIALIZED;
...
DXWEXTERN LoadImageW_Type pLoadImageW;
DXWEXTERN GetAsyncKeyState_Type pGetAsyncKeyState;
DXWEXTERN EnumDisplayMonitors_Type pEnumDisplayMonitors;
...
extern LONG WINAPI extChangeDisplaySettingsExW(LPCWSTR, DEVMODEW *, HWND, DWORD, LPVOID);
extern BOOL WINAPI extClientToScreen(HWND, LPPOINT);
extern BOOL WINAPI extClipCursor(LPRECT);
extern HWND WINAPI extCreateDialogIndirectParamA(HINSTANCE, LPCDLGTEMPLATEA, HWND, DLGPROC, LPARAM);
extern HWND WINAPI extCreateDialogIndirectParamW(HINSTANCE, LPCDLGTEMPLATEW, HWND, DLGPROC, LPARAM);
extern HWND WINAPI extCreateDialogParamA(HINSTANCE, LPCSTR, HWND, DLGPROC, LPARAM);
extern HWND WINAPI extCreateDialogParamW(HINSTANCE, LPCWSTR, HWND, DLGPROC, LPARAM);
...
extern LONG WINAPI extEnumDisplaySettingsA(LPCSTR, DWORD, DEVMODEA *);
extern LONG WINAPI extEnumDisplaySettingsW(LPCWSTR, DWORD, DEVMODEW *);
...
extern HDESK WINAPI extCreateDesktopA(LPCTSTR, LPCTSTR, DEVMODE *, DWORD, ACCESS_MASK, LPSECURITY_ATTRIBUTES);
...
extern BOOL WINAPI extScrollWindow(HWND, int, int, const RECT *, const RECT *);
extern INT_PTR WINAPI extDialogBoxParamA(HINSTANCE, LPCSTR, HWND, DLGPROC, LPARAM);
extern INT_PTR WINAPI extDialogBoxParamW(HINSTANCE, LPCWSTR, HWND, DLGPROC, LPARAM);
...
extern INT_PTR WINAPI extDialogBoxIndirectParamA(HINSTANCE, LPCDLGTEMPLATEA, HWND, DLGPROC, LPARAM);
extern INT_PTR WINAPI extDialogBoxIndirectParamW(HINSTANCE, LPCDLGTEMPLATEW, HWND, DLGPROC, LPARAM);
...
extern HBITMAP WINAPI extLoadBitmapW(HINSTANCE, LPCWSTR);
...
HANDLE WINAPI extLoadImageW(HINSTANCE, LPCWSTR, UINT, int, int, UINT);
