...
#define TRACESUFFIX 
#endif
#define VERSION "v2.06.15.rc7" DEBUGSUFFIX STREAMSUFFIX TRACESUFFIX
...
static char *FlagNames[24][32] ={{
	...
	"GETALLMESSAGES",	"NONANTIALIASEDFONTS","MCISINGLETHREADED","FINDCLOSECHECK",	
	"ADDSHAREDDIRPATH",	"FIXGNOMEMOVIES",	"NOPALETTEANIMATION","",	
	"",					"",					"",					"",	
	"",					"",					"",					"",	
	"",					"",					"",					"",	
	"",					"",					"",					"",	
