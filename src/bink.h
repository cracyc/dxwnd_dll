// bink.h for DxWnd
// beware: this is no way an actual bink.h file, it is meant to collect the definitions relevant for DxWnd
// and classified according the different bink versions.
