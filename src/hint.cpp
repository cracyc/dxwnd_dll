...
HintEntry_Type HintTable[]={
	...
	{FALSE, "Hooked address update. May need to check the \"Do hook update\" (HOOKDOUPDATE) flag"},
	{FALSE, "Xinput dll dependency. You may take advantage of joystick emulation"},
	{FALSE, "The proxy of a system dll was found on the local folder.\nYou may consider removing it"},
	{FALSE, "The unsupported IID_Direct3DRampDevice is used, consider using the \"d3d:RampToRGBDevice\" tweak"},
	{FALSE, "Device controls detected. There might be a CD copy protection"},
	{FALSE, "Process creation detected. It could be necessary to hook the new process"},
	{FALSE, ""}
};
