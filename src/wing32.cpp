...
extern UINT WINAPI extSetDIBColorTable(HDC, UINT, UINT, const RGBQUAD *);
...
BOOL WINAPI extWinGBitBlt(HDC hdcDst, INT xDst, INT yDst, INT width, INT height, HDC hdcSrc, INT xSrc, INT ySrc )
{
	...
	if(dxw.dwDFlags & MARKWING32) dxw.Mark(hdcDst, TRUE, RGB(0, 255, 0), xDst, yDst, width, height);
#ifndef DXW_NOTRACES
	if((dxw.dwDFlags & DUMPDEVCONTEXT) && dxw.bCustomKeyToggle) DumpHDC(hdcSrc, 0, 0, 0, 0);
#endif // DXW_NOTRACES
	return ret;
}
                            ...
                            HDC hdcSrc, INT xSrc, INT ySrc, INT widthSrc, INT heightSrc )
{
	...
	if(dxw.dwDFlags & MARKWING32) dxw.Mark(hdcDst, TRUE, RGB(255, 0, 0), xDst, yDst, widthDst, heightDst);
#ifndef DXW_NOTRACES
	if((dxw.dwDFlags & DUMPDEVCONTEXT) && dxw.bCustomKeyToggle) DumpHDC(hdcSrc, 0, 0, 0, 0);
#endif // DXW_NOTRACES
    return ret;
