...
typedef BOOL	(WINAPI *GetDiskFreeSpaceExA_Type)(LPCSTR, PULARGE_INTEGER, PULARGE_INTEGER, PULARGE_INTEGER);
typedef BOOL	(WINAPI *GetDiskFreeSpaceW_Type)(LPCWSTR, LPDWORD, LPDWORD, LPDWORD, LPDWORD);
typedef BOOL	(WINAPI *GetDiskFreeSpaceExW_Type)(LPCWSTR, PULARGE_INTEGER, PULARGE_INTEGER, PULARGE_INTEGER);
typedef UINT	(WINAPI *GetDriveTypeA_Type)(LPCSTR);
typedef UINT	(WINAPI *GetDriveTypeW_Type)(LPCWSTR);
...
typedef HANDLE	(WINAPI *FindFirstFileExA_Type)(LPCSTR, FINDEX_INFO_LEVELS, LPWIN32_FIND_DATAA, FINDEX_SEARCH_OPS, LPVOID, DWORD);
...
typedef HANDLE	(WINAPI *FindFirstFileExW_Type)(LPCWSTR, FINDEX_INFO_LEVELS, LPWIN32_FIND_DATAW, FINDEX_SEARCH_OPS, LPVOID, DWORD);
...
typedef BOOL	(WINAPI *GetVolumeInformationW_Type)(LPCWSTR, LPWSTR, DWORD, LPDWORD, LPDWORD, LPDWORD, LPWSTR, DWORD);
...
typedef HANDLE  (WINAPI *CreateFileMappingW_Type)(HANDLE, LPSECURITY_ATTRIBUTES, DWORD, DWORD, DWORD, LPCWSTR);
typedef HANDLE  (WINAPI *OpenFileMappingA_Type)(DWORD, BOOL, LPCSTR);
typedef HANDLE  (WINAPI *OpenFileMappingW_Type)(DWORD, BOOL, LPCWSTR);
...
DXWEXTERN GetDiskFreeSpaceExA_Type pGetDiskFreeSpaceExA DXWINITIALIZED;
DXWEXTERN GetDiskFreeSpaceW_Type pGetDiskFreeSpaceW DXWINITIALIZED;
DXWEXTERN GetDiskFreeSpaceExW_Type pGetDiskFreeSpaceExW DXWINITIALIZED;
...
DXWEXTERN GetTickCount64_Type pGetTickCount64 DXWINITIALIZED;
...
DXWEXTERN FindFirstFileExA_Type pFindFirstFileExA;
DXWEXTERN FindFirstFileExW_Type pFindFirstFileExW;
DXWEXTERN FindNextFileA_Type pFindNextFileA;
DXWEXTERN FindFirstFileW_Type pFindFirstFileW;
DXWEXTERN FindNextFileW_Type pFindNextFileW;
DXWEXTERN GetFileAttributesA_Type pGetFileAttributesA;
DXWEXTERN GetVolumeInformationA_Type pGetVolumeInformationA;
DXWEXTERN GetVolumeInformationW_Type pGetVolumeInformationW;
...
DXWEXTERN DeleteFileW_Type pDeleteFileW;
...
DXWEXTERN CreateFileMappingW_Type pCreateFileMappingW;
DXWEXTERN OpenFileMappingA_Type pOpenFileMappingA;
DXWEXTERN OpenFileMappingW_Type pOpenFileMappingW;
...
extern BOOL WINAPI extGetDiskFreeSpaceExA(LPCSTR, PULARGE_INTEGER, PULARGE_INTEGER, PULARGE_INTEGER);
extern BOOL WINAPI extGetDiskFreeSpaceW(LPCWSTR, LPDWORD, LPDWORD, LPDWORD, LPDWORD);
extern BOOL WINAPI extGetDiskFreeSpaceExW(LPCWSTR, PULARGE_INTEGER, PULARGE_INTEGER, PULARGE_INTEGER);
extern UINT WINAPI extGetDriveTypeA(LPCSTR);
extern UINT WINAPI extGetDriveTypeW(LPCWSTR);
...
extern ULONGLONG WINAPI extGetTickCount64(void);
...
extern void WINAPI extOutputDebugStringA(LPCSTR);
extern void WINAPI extOutputDebugStringW(LPCWSTR);
extern HANDLE WINAPI extFindFirstFileA(LPCTSTR, LPWIN32_FIND_DATAA);
extern HANDLE WINAPI extFindFirstFileExA(LPCSTR, FINDEX_INFO_LEVELS, LPWIN32_FIND_DATAA, FINDEX_SEARCH_OPS, LPVOID, DWORD);
extern BOOL WINAPI extFindNextFileA(HANDLE, LPWIN32_FIND_DATAA);
extern HANDLE WINAPI extFindFirstFileW(LPCWSTR, LPWIN32_FIND_DATAW);
extern HANDLE WINAPI extFindFirstFileExW(LPCWSTR, FINDEX_INFO_LEVELS, LPWIN32_FIND_DATAW, FINDEX_SEARCH_OPS, LPVOID, DWORD);
extern BOOL WINAPI extFindNextFileW(HANDLE, LPWIN32_FIND_DATAW);
...
extern BOOL WINAPI extGetVolumeInformationW(LPCWSTR, LPWSTR, DWORD, LPDWORD, LPDWORD, LPDWORD, LPWSTR, DWORD);
...
extern BOOL WINAPI extDeleteFileW(LPCWSTR);
...
extern HANDLE WINAPI extCreateFileMappingW(HANDLE, LPSECURITY_ATTRIBUTES, DWORD, DWORD, DWORD, LPCWSTR);
extern HANDLE WINAPI extOpenFileMappingA(DWORD, BOOL, LPCSTR);
extern HANDLE WINAPI extOpenFileMappingW(DWORD, BOOL, LPCWSTR);
