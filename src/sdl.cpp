...
//#define _SDL_DEBUG
//#define SDLIMAGEHOOKS

#ifndef DXW_NOTRACES
#define IfSDLError(ret)	if(ret) OutErrorSDL("%s: ERROR err=\"%s\"\n", ApiRef, intSDL_ErrorMessage())
#else
...
// definition of SDL_Surface for SDL2 library - it's different from SDL1!!!
...
typedef void (* SDL_QuitSubSystem_Type)(Uint32);
...
typedef int (*SDL_CDNumDrives_Type)(void);
typedef const char *(*SDL_CDName_Type)(int);
...
typedef void (*SDL_SetWindowGrab_Type)(SDL_Window *, SDL_bool);
typedef void (*SDL_SetWindowResizable_Type)(SDL_Window *, SDL_bool);
typedef int (*SDL_SetRelativeMouseMode_Type)(SDL_bool);
typedef void (*SDL_WarpMouseInWindow_Type)(SDL_Window *, int, int);
typedef int (*SDL_WarpMouseGlobal_Type)(int, int);
typedef int (*SDL_GL_GetDrawableSize_Type)(int *, int *);
typedef int (*SDL_GetRendererOutputSize_Type)(SDL_Renderer *, int *, int *);
...
SDL_QuitSubSystem_Type pSDL_QuitSubSystem;
...
SDL_CDNumDrives_Type pSDL_CDNumDrives;
SDL_CDName_Type pSDL_CDName;
SDL_UpdateWindowSurface_Type pSDL_UpdateWindowSurface;
SDL_GetWindowSurface_Type pSDL_GetWindowSurface;
SDL_SetPaletteColors_Type pSDL_SetPaletteColors;
SDL_SetWindowGrab_Type pSDL_SetWindowGrab;
SDL_SetWindowResizable_Type pSDL_SetWindowResizable;
SDL_SetRelativeMouseMode_Type pSDL_SetRelativeMouseMode;
SDL_WarpMouseInWindow_Type pSDL_WarpMouseInWindow;
SDL_WarpMouseGlobal_Type pSDL_WarpMouseGlobal;
SDL_GL_GetDrawableSize_Type pSDL_GL_GetDrawableSize;
SDL_GetRendererOutputSize_Type pSDL_GetRendererOutputSize;
...
void extSDL_QuitSubSystem(Uint32);
...
int extSDL_CDNumDrives(void);
const char *extSDL_CDName(int);
int extSDL_UpdateWindowSurface(SDL_Window *);
SDL_Surface *extSDL_GetWindowSurface(SDL_Window *);
int extSDL_SetPaletteColors(SDL_Palette *, const SDL_Color *, int, int);
void extSDL_SetWindowGrab(SDL_Window *, SDL_bool);
void extSDL_SetWindowResizable(SDL_Window *, SDL_bool);
int extSDL_SetRelativeMouseMode(SDL_bool);
void extSDL_WarpMouseInWindow(SDL_Window *, int, int);
int extSDL_WarpMouseGlobal(int, int);
int extSDL_GL_GetDrawableSize(int *, int *);
int extSDL_GetRendererOutputSize(SDL_Renderer *, int *, int *);
...
static HookEntryEx_Type Hooks[]={
	...
	{HOOK_IAT_CANDIDATE, 0, "SDL_UpdateWindowSurface", (FARPROC)NULL, (FARPROC *)&pSDL_UpdateWindowSurface, (FARPROC)extSDL_UpdateWindowSurface},
	{HOOK_IAT_CANDIDATE, 0, "SDL_GetWindowSurface", (FARPROC)NULL, (FARPROC *)&pSDL_GetWindowSurface, (FARPROC)extSDL_GetWindowSurface},
	{HOOK_IAT_CANDIDATE, 0, "SDL_SetPaletteColors", (FARPROC)NULL, (FARPROC *)&pSDL_SetPaletteColors, (FARPROC)extSDL_SetPaletteColors},
	//{HOOK_IAT_CANDIDATE, 0, "SDL_ListModes", (FARPROC)NULL, (FARPROC *)&pSDL_ListModes, (FARPROC)extSDL_ListModes},
	{HOOK_IAT_CANDIDATE, 0, "SDL_WarpMouseInWindow", (FARPROC)NULL, (FARPROC *)&pSDL_WarpMouseInWindow, (FARPROC)extSDL_WarpMouseInWindow},
	{HOOK_IAT_CANDIDATE, 0, "SDL_WarpMouseGlobal", (FARPROC)NULL, (FARPROC *)&pSDL_WarpMouseGlobal, (FARPROC)extSDL_WarpMouseGlobal},
	{HOOK_IAT_CANDIDATE, 0, "SDL_GL_GetDrawableSize", (FARPROC)NULL, (FARPROC *)&pSDL_GL_GetDrawableSize, (FARPROC)extSDL_GL_GetDrawableSize},
	{HOOK_IAT_CANDIDATE, 0, "SDL_GetRendererOutputSize", (FARPROC)NULL, (FARPROC *)&pSDL_GetRendererOutputSize, (FARPROC)extSDL_GetRendererOutputSize},
...
static HookEntryEx_Type SDL1Hooks[]={
	{HOOK_IAT_CANDIDATE, 0, "SDL_PeepEvents", (FARPROC)NULL, (FARPROC *)&pSDL_PeepEvents1, (FARPROC)extSDL_PeepEvents1},
	{HOOK_IAT_CANDIDATE, 0, 0, NULL, 0, 0} // terminator
}; 

static HookEntryEx_Type SDL2Hooks[]={
	{HOOK_IAT_CANDIDATE, 0, "SDL_PeepEvents", (FARPROC)NULL, (FARPROC *)&pSDL_PeepEvents2, (FARPROC)extSDL_PeepEvents2},
	{HOOK_IAT_CANDIDATE, 0, 0, NULL, 0, 0} // terminator
}; 
...
static HookEntryEx_Type TraceHooks[]={
	...
	{HOOK_IAT_CANDIDATE, 0, "SDL_SetWindowGrab", (FARPROC)NULL, (FARPROC *)&pSDL_SetWindowGrab, (FARPROC)extSDL_SetWindowGrab},
	{HOOK_IAT_CANDIDATE, 0, "SDL_SetWindowResizable", (FARPROC)NULL, (FARPROC *)&pSDL_SetWindowResizable, (FARPROC)extSDL_SetWindowResizable},
	{HOOK_IAT_CANDIDATE, 0, "SDL_SetRelativeMouseMode", (FARPROC)NULL, (FARPROC *)&pSDL_SetRelativeMouseMode, (FARPROC)extSDL_SetRelativeMouseMode},
	{HOOK_IAT_CANDIDATE, 0, 0, NULL, 0, 0} // terminator
};
...
static HookEntryEx_Type FakeCDHooks[]={
	{HOOK_IAT_CANDIDATE, 0, "SDL_CDNumDrives", (FARPROC)NULL, (FARPROC *)&pSDL_CDNumDrives, (FARPROC)extSDL_CDNumDrives},
	{HOOK_IAT_CANDIDATE, 0, "SDL_CDName", (FARPROC)NULL, (FARPROC *)&pSDL_CDName, (FARPROC)extSDL_CDName},
	{HOOK_IAT_CANDIDATE, 0, 0, NULL, 0, 0} // terminator
};

#ifdef SDLIMAGEHOOKS
typedef SDL_Surface *(* IMG_Load_Type)(const char *file);
IMG_Load_Type pIMG_Load;
SDL_Surface *extIMG_Load(const char *file);

static HookEntryEx_Type ImageHooks[]={
	{HOOK_IAT_CANDIDATE, 0, "IMG_Load", (FARPROC)NULL, (FARPROC *)&pIMG_Load, (FARPROC)extIMG_Load},
	{HOOK_IAT_CANDIDATE, 0, 0, NULL, 0, 0} // terminator
};
#endif // SDLIMAGEHOOKS
...
void HookSDL(HMODULE module)
{
	...
	switch(dwSDLVersion){
		case 1: HookLibraryEx(module, SDL1Hooks, libname); break;
		case 2: HookLibraryEx(module, SDL2Hooks, libname); break;
		default: OutErrorSDL("HookSDL: invalide SDL version=%d\n", dwSDLVersion); break;
	}
	...
	if(dxw.dwFlags10 & FAKECDDRIVE) HookLibraryEx(module, FakeCDHooks, libname);
	HMODULE sdl;
	sdl = (*pLoadLibraryA)(libname);
#ifndef DXW_NOTRACES
	if(sdl){
		if(!pSDL_GetError) pSDL_GetError = (SDL_GetError_Type)(*pGetProcAddress)(sdl, "SDL_GetError");
		if(!pSDL_GetError) OutErrorSDL("HookSDL: GetProcAddress ERROR err=%d @%d\n", GetLastError(), __LINE__);
	}
	else{
		OutErrorSDL("HookSDL: LoadLibrary ERROR err=%d @%d\n", GetLastError(), __LINE__);
	}
#endif // DXW_NOTRACES
	if(sdl && bEmulation){
		pStretch = NULL;
		if(dxw.dwFlags5 & BILINEARFILTER) pStretch = intSDL_BlitScaled; 
...
#ifndef DXW_NOTRACES
		if(!pSDL_GetWMInfo) OutTraceSDL("HookSDL: no pSDL_GetWMInfo\n");
#endif // DXW_NOTRACES
	}
	if(dwSDLVersion == 2){
		pSDL_GetWindowWMInfo = (SDL_GetWindowWMInfo_Type)(*pGetProcAddress)(sdl, "SDL_GetWindowWMInfo");
#ifndef DXW_NOTRACES
		if(!pSDL_GetWindowWMInfo) OutTraceSDL("HookSDL: no pSDL_GetWindowWMInfo\n");
#endif // DXW_NOTRACES
	}
	if(sdl)(*pFreeLibrary)(sdl);
#ifdef SDLIMAGEHOOKS
	// SDL_Image.dll
	HMODULE sdlhImg = (*LoadLibraryA)("SDL_image.dll");
	if(sdlhImg){
		HookLibraryEx(sdlhImg, ImageHooks, "SDL_image.dll");
	}
#endif // SDLIMAGEHOOKS
}
...
FARPROC Remap_SDL_ProcAddress(LPCSTR proc, HMODULE hModule)
{
	...
	if(dxw.dwFlags10 & FAKECDDRIVE) if(addr=RemapLibraryEx(proc, hModule, FakeCDHooks)) return addr;
	return NULL;
}
...
static char *sState(int state)
{
	char *s;
	switch(state){
		case SDL_QUERY:		s="QUERY"; break;
		case SDL_IGNORE:	s="IGNORE"; break;
		case SDL_ENABLE:	s="ENABLE"; break;
...
static char *intEventCaption(Uint8 type)
{
	char *s;
	switch(type){
		case SDL_NOEVENT: s="NOEVENT"; break;
		case SDL_ACTIVEEVENT: s="ACTIVEEVENT"; break;
		case SDL_KEYDOWN: s="KEYDOWN"; break;
		case SDL_KEYUP: s="KEYUP"; break;
		case SDL_MOUSEMOTION: s="MOUSEMOTION"; break;
		case SDL_MOUSEBUTTONDOWN: s="MOUSEBUTTONDOWN"; break;
		case SDL_MOUSEBUTTONUP: s="MOUSEBUTTONUP"; break;
		case SDL_JOYAXISMOTION: s="JOYAXISMOTION"; break;
		case SDL_JOYBALLMOTION: s="JOYBALLMOTION"; break;
		case SDL_JOYHATMOTION: s="JOYHATMOTION"; break;
		case SDL_JOYBUTTONDOWN: s="JOYBUTTONDOWN"; break;
		case SDL_JOYBUTTONUP: s="JOYBUTTONUP"; break;
		case SDL_QUIT: s="QUIT"; break;
		case SDL_SYSWMEVENT: s="SYSWMEVENT"; break;
		case SDL_EVENT_RESERVEDA: s="EVENT_RESERVEDA"; break;
		case SDL_EVENT_RESERVEDB: s="EVENT_RESERVEDB"; break;
		case SDL_VIDEORESIZE: s="VIDEORESIZE"; break;
		case SDL_VIDEOEXPOSE: s="VIDEOEXPOSE"; break;
...
{
	switch(act){
		case SDL_ADDEVENT: return "ADDEVENT"; break;
		case SDL_PEEKEVENT: return "PEEKEVENT"; break;
		case SDL_GETEVENT: return "GETEVENT"; break;
	}
	return "???";
}

char *sCreateWindowFlags(Uint32 flags)
{
	static char s[128];
	strcpy(s, "SDL_WINDOW_");
	if(flags & SDL_WINDOW_FULLSCREEN) strcat(s, "FULLSCREEN+");
	if(flags & SDL_WINDOW_FULLSCREEN_DESKTOP) strcat(s, "FULLSCREEN_DESKTOP+");
	if(flags & SDL_WINDOW_OPENGL) strcat(s, "OPENGL+");
	//if(flags & SDL_WINDOW_VULKAN) strcat(s, "VULCAN+");
	if(flags & SDL_WINDOW_HIDDEN) strcat(s, "HIDDEN+");
	if(flags & SDL_WINDOW_BORDERLESS) strcat(s, "BORDERLESS+");
	if(flags & SDL_WINDOW_RESIZABLE) strcat(s, "RESIZABLE+");
	if(flags & SDL_WINDOW_MINIMIZED) strcat(s, "MINIMIZED+");
	if(flags & SDL_WINDOW_MAXIMIZED) strcat(s, "MAXIMIZED+");
	if(flags & SDL_WINDOW_INPUT_GRABBED) strcat(s, "INPUT_GRABBED+");
	if(flags & SDL_WINDOW_ALLOW_HIGHDPI) strcat(s, "ALLOW_HIGHDPI+");
	UINT l=strlen(s);
	if (l>strlen("SDL_WINDOW_")) s[l-1]=0; // delete last '+' if any
	else s[0]=0;
	return(s);
}
#endif // DXW_NOTRACES 
...
SDL_Rect intSDL_CompleteRect (SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect)
{
	...
	if(srcrect == NULL){
		...
		CompleteRect.w = src->w; CompleteRect.h = src->h;
	}
	else{
...
static HWND intSDL2_GethWnd()
{
	...
	info.version.minor = 0;
	info.version.patch = 0;
	if (pSDL_GetWindowWMInfo && ((*pSDL_GetWindowWMInfo)(gSDL_MainWindow, (SDL_SysWMinfo *)&info) >= 0)){
		hwnd = info.window;
	}
	return hwnd;
}

static void intSDL_ShowOverlay()
{
	HWND hwnd;
	RECT rect;
	switch(dwSDLVersion){
		case 1: hwnd = intSDL1_GethWnd(); break;
		case 2: hwnd = intSDL2_GethWnd(); break;
	}
	if(hwnd){
...
SDL_Rect intSDL_ScaleRect (SDL_Surface *surface, const SDL_Rect *rect)
{
	...
	if(rect == NULL){
		...
		ScaledRect.w = surface->w; ScaledRect.h = surface->h;
	}
	else{
		ScaledRect = *rect;
	}
	if((*pGetClientRect)(dxw.GethWnd(), &wrect)){
		OutDebugSDL("ScaledRect hwnd=%#x wrect=(%d,%d)-(%d,%d)\n", 
			dxw.GethWnd(), wrect.left, wrect.top, wrect.right, wrect.bottom);
		...
		OutDebugSDL("ScaledRect: GetClientRect ERROR hwnd=%#x err=%d\n", dxw.GethWnd(), GetLastError());
	}
	// trim
...
int intSDL_Refresh(char *apiname, const SDL_Rect *rect)
{
	...
	if(ret=(*pStretch)(gSDL_EmulatedVideo, rect, gSDL_VideoSurface, dstrect)){
		OutErrorSDL("%s: StretchBlt ERROR err=%#x(\"%s\") @%d\n", apiname, ret, intSDL_ErrorMessage(), __LINE__);
		OutErrorSDL("> src=%#x srcrect=%s\n", gSDL_EmulatedVideo, sRect(rect));
		OutErrorSDL("> dst=%#x dstrect=%s\n", gSDL_VideoSurface, sRect(dstrect));
	}
...
void SDLScreenRefresh()
{
	if(pStretch && gSDL_EmulatedVideo && gSDL_VideoSurface){
		...
		width = (Uint16)(wrect.right - wrect.left);
		height = (Uint16)(wrect.bottom - wrect.top);
		bpp = gSDL_VideoSurface->format->BitsPerPixel; // to fix for SDL2
		if(dwSDLVersion == 2) { 
			SDL2_Surface *sdl2 = (SDL2_Surface *)gSDL_VideoSurface;
			bpp = sdl2->format->BitsPerPixel;
		}
		...
		if(ret=(*pStretch)(gSDL_EmulatedVideo, NULL, gSDL_VideoSurface, NULL)){
			OutErrorSDL("SDLScreenRefresh: StretchBlt ERROR err=%#x(\"%s\") @%d\n", ret, intSDL_ErrorMessage(), __LINE__);
		}
	}
}
...
static int intSDL_BlitScaled(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect)
{
	...
	switch(dwSDLVersion){
		case 1:
			GMask = src->format->Gmask;
			break;
		case 2:
			GMask = ((SDL2_Surface *)src)->format->Gmask;
			break;
	}
	...
	if(!pResize_HQ) {
		...
		if(!filter){
			OutErrorSDL("intSDL_BlitScaled: unsupported depth Gmask=%#x\n", GMask);
			return -1;
		}
...
{
	HWND hwnd;
	OutTraceSDL("%s: SDL SethWnd window=%#x\n", api, window);
	...
	if(pSDL_GetWindowWMInfo){
		...
		if(dwSDLVersion == 2) {
			SDL2_SysWMinfo wmInfo2;
			wmInfo2.version.major = 2;
			wmInfo2.version.minor = 0;
			wmInfo2.version.patch = 0;
			(*pSDL_GetWindowWMInfo)(window, (SDL_SysWMinfo *)&wmInfo2);
			hwnd = wmInfo2.window;
		}
		dxw.SethWnd(hwnd);
		OutTraceSDL("%s: SDL SethWnd version=%d hwnd=%#x\n", api, dwSDLVersion, hwnd);
	}
	else{
		OutErrorSDL("%s: ASSERT no SDL_GetWindowWMInfo!!\n", api);
	}
}
...
void extSDL_QuitSubSystem(Uint32 flags)
{
	ApiName("SDL_QuitSubSystem");

	OutTraceSDL("%s: flags=%#x(%s)\n", ApiRef, flags, ExplainInitFlags(flags));
	(*pSDL_QuitSubSystem)(flags);
}
...
SDL_Surface *extSDL_SetVideoMode(int width, int height, int bpp, Uint32 flags)
{
	...
	if((dxw.Windowize && (flags & SDL_FULLSCREEN)) || 
		...
		// 2.05.92 fix: suppress SDL_DOUBLEBUF. Found in "Spirit Stallion of the Cimarron".
		flags &= ~SDL_DOUBLEBUF; 
...
Uint32 extSDL_GetMouseState(int* x, int* y)
{
	...
	if(x) GetHookInfo()->SDLCursorX=(short)*x;
	if(y) GetHookInfo()->SDLCursorY=(short)*y;
	return ret;
}
...
int intSDL_Blit(ApiArg, SDL_BlitSurface_Type pBlit, SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect)
{
	int ret;
	...
	OutTraceSDL("%s: src=%#x srcrect=%s dst=%#x dstrect=%s\n", ApiRef, src, s1, dst, s2);
#endif // DXW_NOTRACES

	// v2.04.47: Blit from NULL surface is not allowed and should return an error, do not try to redirect to video surface
...
#ifndef DXW_NOTRACES
		if(ret){
			OutErrorSDL("%s: ERROR err=%#x(\"%s\") @%d\n", ApiRef, ret, intSDL_ErrorMessage(), __LINE__);
		}
#endif // DXW_NOTRACES
		OutTraceSDL("%s: EMULATION stretch=%#x->%#x\n", ApiRef, gSDL_EmulatedVideo, gSDL_VideoSurface);
		// v2.05.65 fix: SDL2 doesn't seem to like the CompleteRect value for full surface stretching,
		// using NULL rects works instead! Fixed "keeperfx" SDL2 port of "Dungeon Keeper 2".
		if((srcrect == NULL) && (dstrect == NULL)){
			OutTraceSDL("%s: EMULATION stretching to NULL surface\n", ApiRef);
			ret = intSDL_Refresh(ApiRef, NULL);
		}
		else {
			SDL_Rect crect;
	...
	if((dxw.dwFlags9 & SDLFORCESTRETCH) && (dst==gSDL_VideoSurface)) {
		SDL_Rect srect;
		srect = intSDL_CompleteRect (src, srcrect, dst, dstrect);
		OutTraceSDL("%s: STRETCH srect={pos=(%d,%d) siz=(%dx%d)}\n", ApiRef, srect.x, srect.y, srect.w, srect.h);
		ret = (*pBlit)(src, srcrect, dst, &srect);
	}
	else {
...
{ ApiName("SDL_UpperBlit"); return intSDL_Blit(ApiRef, pSDL_UpperBlit, src, srcrect, dst, dstrect); }
int extSDL_LowerBlit(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect)
{ ApiName("SDL_LowerBlit"); return intSDL_Blit(ApiRef, pSDL_LowerBlit, src, srcrect, dst, dstrect); }
int extSDL_BlitSurface(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect)
{ ApiName("SDL_BlitSurface"); return intSDL_Blit(ApiRef, pSDL_BlitSurface, src, srcrect, dst, dstrect); }
int extSDL_BlitScaled(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect)
{ ApiName("SDL_BlitScaled"); return intSDL_Blit(ApiRef, pSDL_BlitScaled, src, srcrect, dst, dstrect); }
int extSDL_SoftStretch(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect)
{ ApiName("SDL_SoftStretch"); return intSDL_Blit(ApiRef, pSDL_SoftStretch, src, srcrect, dst, dstrect); }
...
static char *sAlphaFlag(Uint32 f)
{
	char *s;
	switch(f){
		case SDL_SRCALPHA: s="SDL_SRCALPHA"; break;
		default: s="??"; break;
	}
	return s;
}
...
void extSDL_WarpMouse(Uint16 x, Uint16 y)
{
	...
	if(dxw.dwFlags18 & SDLFIXMOUSE){
		...
		cur.x = x;
		cur.y = y;
		dxw.MapClient(&cur); // <--- map the coordinates 
		//if(dxw.MustFixMouse) dxw.MapClient(&cur); // <--- does it twice ... 
		x = (Uint16)cur.x;
		y = (Uint16)cur.y;
...
SDL_bool extSDL_SetClipRect(SDL_Surface *surface, SDL_Rect *rect)
{
	...
	if(bEmulation && (surface==gSDL_EmulatedVideo)){
		...
		if(!(ret = (*pSDL_SetClipRect)(gSDL_VideoSurface, &crect))){
			OutErrorSDL("%s: EMULATION ERROR @%d\n", ApiRef, __LINE__);
			return ret;
		}
	}	
...
#ifndef DXW_NOTRACES
	switch((int)ret){
		case -1: OutTraceSDL("%s: ret=-1 all resolutions available\n", ApiRef); 
			break;
		case  0: OutTraceSDL("%s: ret=0 no modes available\n", ApiRef); 
			break;
		default: OutTraceSDL("%s: available modes:\n", ApiRef); 
			for (int i=0; ret[i]; ++i){
				OutTraceSDL(" %dx%d\n", ret[i]->w, ret[i]->h); 
			}
			break;
...
Sint16 extSDL_JoystickGetAxis(SDL_Joystick *joy, int axis)
{
	...
	if(dxw.dwFlags6 & VIRTUALJOYSTICK) {
		...
		switch (axis){
			case 0: ret=(Sint16)((jinfo.wXpos * 32768) / 128); break;
			case 1: ret=(Sint16)((jinfo.wYpos * 32768) / 128); break;
			default: ret=0;
		}
	}
	else
...
Uint8 extSDL_JoystickGetButton(SDL_Joystick *joy, int button)
{
	...
	if(dxw.dwFlags6 & VIRTUALJOYSTICK) {
		...
		bActive = vjGetJoy(ApiRef, &jinfo);
		switch (button){
			case 0: ret=(Uint8)(jinfo.wButtons & 0x00000001) ? 1 : 0; break;
			case 1: ret=(Uint8)(jinfo.wButtons & 0x00000002) ? 1 : 0; break;
			default: ret=0;
		}
	}
	else
...
int extSDL_JoystickEventState(int state)
{
	...
	if(dxw.dwFlags6 & VIRTUALJOYSTICK){
		switch(state){
			case SDL_QUERY:		break;
			case SDL_IGNORE:	gSDL_JoystickEventState = FALSE; break;
			case SDL_ENABLE:	gSDL_JoystickEventState = TRUE; break;
			default:			gSDL_JoystickEventState = state; break;
		}
...
//		case SDL_KEYDOWN:
		case SDL_KEYUP:
			// the ESC key corresponds to the scancode 1
			if((dxw.dwFlags16 & CONFIRMESCAPE) && (e->key.keysym.scancode == 1)){
				OutTrace("ESC detected in HandlePulledEvent\n");
...
int extSDL_PollEvent(SDL_Event *e)
{
	...
	OutDebugSDL("%s: e.type=%d(%s)\n", ApiRef, e->type, intEventCaption(e->type));
...
int extSDL_PushEvent(SDL_Event *e)
{
	...
	OutTraceSDL("%s: e.type=%d(%s) ret=%d\n", ApiRef, e->type, intEventCaption(e->type), ret);
	return ret;
}
...
#define SDL_WINDOWPOS_MASK 0xFFFF0000u
#ifndef DXW_NOTRACES
void sPos(int p, char *str)
{
	switch(p & SDL_WINDOWPOS_MASK){
		case SDL_WINDOWPOS_CENTERED_MASK: strcpy(str, "CENTERED"); break;
			case SDL_WINDOWPOS_UNDEFINED_MASK: strcpy(str, "UNDEFINED"); break;
		default: sprintf(str, "%d", p); break;
	}
}
#endif // DXW_NOTRACES
...
SDL_Window *extSDL_CreateWindow(const char *title, int x, int y, int w, int h, Uint32 flags)
{
	...
	if(IsTraceSDL){
		...
		sPos(x, posx);
		sPos(y, posy);
		OutTrace("%s: title=\"%s\" pos=(%s,%s) siz=(%dx%d) flags=%#x(%s)\n", ApiRef, title, posx, posy, w, h, flags, sCreateWindowFlags(flags));
	}
#endif // DXW_NOTRACES
	if(dxw.Windowize && (flags & SDL_WINDOW_FULLSCREEN)){
		dxw.SetScreenSize(w, h);
		isFullscreen = TRUE;
		OutTraceSDL("%s: set fullscreen size=(%dx%d)\n", ApiRef, dxw.GetScreenWidth(), dxw.GetScreenHeight());
	}
	if(dxw.Windowize){
	...
	window = (*pSDL_CreateWindow)(title, x, y, w, h, flags);
	if(isFullscreen) {
...
{
	int ret;
	ApiName("SDL_CDNumDrives");

	if(dxw.dwFlags10 & FAKECDDRIVE){
		OutTraceSDL("%s: FAKECDDRIVE ret=1\n", ApiRef);
		return 1;
	}
	ret = (*pSDL_CDNumDrives)();
	OutTraceSDL("%s: ret=%d\n", ApiRef, ret);
	return ret;
}
...
const char *extSDL_CDName(int drive)
{
	const char *ret;
	ApiName("SDL_CDName");

	OutTraceSDL("%s: drive=%d\n", ApiRef, drive);

	if((dxw.dwFlags10 & FAKECDDRIVE) && (drive == 0)){
		extern char *dxwGetFakeDriverPath(char DriverId);
		char *volume = dxwGetFakeDriverPath(DXW_CD_PATH);
		OutTraceSDL("%s: FAKECDDRIVE ret=\"%s\"\n", ApiRef, volume);
		return volume;
	}

	ret = (*pSDL_CDName)(drive);
	OutTraceSDL("%s: ret=\"%s\"\n", ApiRef, ret);
	return ret;
}

int extSDL_UpdateWindowSurface(SDL_Window *window)
{
	int ret;
	ApiName("SDL_UpdateWindowSurface");

	OutTraceSDL("%s: win=%#x\n", ApiRef, window);

	// useless, it's done in SDL_UpperBlit wrapper
	//if(bEmulation) intSDL_Refresh(ApiRef, NULL);		

	ret = (*pSDL_UpdateWindowSurface)(window);
	intSDL_ShowOverlay();
...
SDL_Surface *extSDL_GetWindowSurface(SDL_Window *window)
{
	SDL_Surface *ret;
	ApiName("SDL_GetWindowSurface");

	OutTraceSDL("%s: win=%#x\n", ApiRef, window);

	ret = (*pSDL_GetWindowSurface)(window);
	if(!ret){
		OutTraceSDL("%s: ERROR err=%s\n", ApiRef, (*pSDL_GetError)());
		return ret;
	}

	if(bEmulation){
		OutTraceSDL("%s: actual ret=%#x\n", ApiRef, ret);
		gSDL_VideoSurface = ret;
		SDL2_Surface *s2 = (SDL2_Surface *)ret;
		OutTrace("debug: Bpp=%d RGBA=%#x,%#x,%#x,%#x\n",
			s2->format->BytesPerPixel,
			s2->format->Rmask,
			s2->format->Gmask,
			s2->format->Bmask,
			s2->format->Amask);

		if(gSDL_EmulatedVideo == NULL){
			if(!pSDL_CreateRGBSurface) {
				OutTraceSDL("%s: ERROR no SDL_CreateRGBSurface\n", ApiRef);
				return 0;
			}
			DWORD oWidth = dxw.GetScreenWidth();
			DWORD oHeight = dxw.GetScreenHeight();
			DWORD bpp = dxw.VirtualPixelFormat.dwRGBBitCount;
			if(gSDL_EmulatedVideo && pSDL_FreeSurface) (*pSDL_FreeSurface)(gSDL_EmulatedVideo);
			// create emulated video surface
			OutDebugSDL("%s: building emuvideo wxh=(%dx%d) bpp=%d RGBAmask=(%#x:%#x:%#x:%#x)\n", 
				ApiRef, oWidth, oHeight, bpp,
...
int extSDL_SetPaletteColors(SDL_Palette *palette, const SDL_Color *colors, int firstcolor, int ncolors)
{
	int ret;
	ApiName("SDL_SetPaletteColors");

	OutTraceSDL("%s: palette=%#x colors=%#x first=%d num=%d\n", ApiRef, palette, colors, firstcolor, ncolors);
	ret = (*pSDL_SetPaletteColors)(palette, colors, firstcolor, ncolors);

	return ret;
}

void extSDL_SetWindowGrab(SDL_Window *window, SDL_bool grab)
{
	ApiName("SDL_SetWindowGrab");

	OutTraceSDL("%s: win=%#x grab=%#x\n", ApiRef, window, grab);
	(*pSDL_SetWindowGrab)(window, grab);
}

void extSDL_SetWindowResizable(SDL_Window *window, SDL_bool resizable)
{
	ApiName("SDL_SetWindowResizable");

	OutTraceSDL("%s: win=%#x grab=%#x\n", ApiRef, window, resizable);
	(*pSDL_SetWindowResizable)(window, resizable);
}

int extSDL_SetRelativeMouseMode(SDL_bool enabled)
{
	int ret;
	ApiName("SDL_SetRelativeMouseMode");

	OutTraceSDL("%s: enabled=%#x\n", ApiRef, enabled);
	ret = (*pSDL_SetRelativeMouseMode)(enabled);
	if(ret) OutErrorSDL("%s: ret=%d err=%s\n", ApiRef, ret, intSDL_ErrorMessage());
...
SDL_Surface *extIMG_Load(const char *file)
{
	...
	OutTraceSDL("%s: path=%s\n", ApiRef, file);
	ret = (*pIMG_Load)(file);
	if(ret == 0) OutErrorSDL("%s: ret=%d err=%s\n", ApiRef, ret, intSDL_ErrorMessage());

	return ret;
}
#endif // SDLIMAGEHOOKS

void extSDL_WarpMouseInWindow(SDL_Window *window, int x, int y)
{
	ApiName("SDL_WarpMouseInWindow");

	OutTraceSDL("%s: window=%#x pos(x,y)=(%d, %d)\n", ApiRef, window, x, y);
	(*pSDL_WarpMouseInWindow)(window, x, y);
}


int extSDL_WarpMouseGlobal(int x, int y)
{
	int ret;
	ApiName("SDL_WarpMouseGlobal");

	OutTraceSDL("%s: pos(x,y)=(%d, %d)\n", ApiRef, x, y);
	ret = (*pSDL_WarpMouseGlobal)(x, y);
	if(ret) OutErrorSDL("%s: ret=%d err=%s\n", ApiRef, ret, intSDL_ErrorMessage());
	return ret;
}

int extSDL_GL_GetDrawableSize(int *w, int *h)
{
	int ret;
	ApiName("SDL_GL_GetDrawableSize");

	ret = (*pSDL_GL_GetDrawableSize)(w, h);
	if(ret) {
		OutErrorSDL("%s: ret=%d err=%s\n", ApiRef, ret, intSDL_ErrorMessage());
	}
	else {
		OutTraceSDL("%s: size=(%dx%d)\n", ApiRef, *w, *h);
	}
	return ret;
}

int extSDL_GetRendererOutputSize(SDL_Renderer *renderer, int *w, int *h)
{
	int ret;
	ApiName("SDL_GetRendererOutputSize");

	OutTraceSDL("%s: renderer=%#x\n", ApiRef, renderer);

	ret = (*pSDL_GetRendererOutputSize)(renderer, w, h);
	if(ret) {
		OutErrorSDL("%s: ret=%d err=%s\n", ApiRef, ret, intSDL_ErrorMessage());
	}
	else {
...
void extSDL_PumpEvents(void)
{
	ApiName("SDL_PumpEvents");
	OutTraceSDL("%s: \n", ApiRef);
}

void extSDL_FlushEvent(Uint32 type)
{
	ApiName("SDL_FlushEvent");
	OutTraceSDL("%s: type=%d\n", ApiRef, type);
}

void extSDL_FlushEvents(Uint32 minType, Uint32 maxType)
{
	ApiName("SDL_FlushEvents");
