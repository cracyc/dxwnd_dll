...
public:
	...
	void ClearLogsInFolder(CString);
...
// Generated message map functions
	...
	afx_msg void OnAdd();
	afx_msg void OnAdd(char *, int);
	afx_msg void OnDuplicate();
	afx_msg void OnModify();
	afx_msg void OnCopyPath();
	afx_msg void OnPastePath();
	...
	afx_msg void OnIdentifyMonitors();
	afx_msg void OnRecoverSystemCursors();
