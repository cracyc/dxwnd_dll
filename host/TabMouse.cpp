...
void CTabMouse::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_TRIMMOUSEPOSITION, cTarget->m_TrimMousePosition);
	...
	DDX_Check(pDX, IDC_CENTERONEXIT, cTarget->m_CenterOnExit);
	DDX_Check(pDX, IDC_FIXMOUSELPARAM, cTarget->m_FixMouseLParam);
	DDX_Check(pDX, IDC_ADAPTMOUSESPEED, cTarget->m_AdaptMouseSpeed);
	DDX_Check(pDX, IDC_LOCKCURSORICONS, cTarget->m_LockCursorIcons);
	DDX_Check(pDX, IDC_LOCKSYSCURSORICONS, cTarget->m_LockSysCursorIcons);
	DDX_Check(pDX, IDC_RECOVERSYSCURSORICONS, cTarget->m_RecoverSysCursorIcons);
	// Cursor Clipper
	...
	// Fix mouse bias
	DDX_Check(pDX, IDC_FIXMOUSEBIASX, cTarget->m_FixMouseBiasX);
	DDX_Check(pDX, IDC_FIXMOUSEBIASY, cTarget->m_FixMouseBiasY);
}
